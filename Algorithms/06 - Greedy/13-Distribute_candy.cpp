// PS : There are N children standing in a line. Each child is assigned a rating value. You are giving candies to these children subjected to the following requirements:
// 1. Each child must have at least one candy.
// 2. Children with a higher rating get more candies than their neighbors.
// What is the minimum candies you must give?

// Explanation : For each child, we'll calculate for how long the series is decreasing to the left and to the right (this is not the NGE thing). Both of these can be calculated in O(n) time.
// This number would be the number of chocolates to give to a child
